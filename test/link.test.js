...
it.each([
  ['slack', 'Atlassian (<https://www.atlassian.com|https://www.atlassian.com>)\n'],
  ['html', '<p>Atlassian (<a href="https://www.atlassian.com">https://www.atlassian.com</a>)</p>'],
])('transpiles transparent link as expected for target: %s', (target, expected) => {
  expect(transpileMd('Atlassian ([https://www.atlassian.com](https://www.atlassian.com))', { target })).toBe(expected);
});
